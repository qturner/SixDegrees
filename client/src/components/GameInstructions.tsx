...
export default function GameInstructions() {
  return (
    <div className="bg-white card-radius shadow-card hover:shadow-card-hover transition-all duration-300 spacing-lg mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="space-y-2 text-body-sm">
            <div className="bg-gray-50 spacing-sm input-radius transition-all duration-200 hover:bg-gray-100">
